...
IMPORTANT: For Railway deployment, use railway_simple.py instead of this file
"""
import os
import asyncio
import logging
...
def webhook():
    ...
    if request.method == 'GET':
        return {'status': 'ok', 'message': 'Webhook endpoint is ready'}, 200
    try:
...
if __name__ == '__main__':
    ...
    try:
        ...
        import logging
        import os
        from bot_simple import initialize_simple_bot
        
        # Initialize bot for webhook mode
        print("🔧 Initializing simplified Telegram bot for webhook mode...")
        if not initialize_simple_bot(app):
